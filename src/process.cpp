...
// Return the uptime running of this process in seconds
long int Process::UpTime() {
  // std::cout << LinuxParser::UpTime(this->pid) << std::endl;
  return LinuxParser::UpTime(this->pid);
}

// Return the disk read rate of this process
double Process::GetDiskReadRateForPID() { return LinuxParser::GetDiskReadRateForPID(this->pid); }

// Return the disk write rate of this process in seconds
double Process::GetDiskWriteRateForPID() { return LinuxParser::GetDiskWriteRateForPID(this->pid); }
